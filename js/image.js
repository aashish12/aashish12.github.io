...
// const fixednavlogo = document.querySelectorAll(".fixed menucross");

// fixednavlogo.addEventListener("click", function(){
//     document.getElementById("k2logo").src = "images/logo/k2.png";
//     alert("hello");
// })
